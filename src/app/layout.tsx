...
export const metadata: Metadata = {
  title: "The Grand Haven - Luxury Hotel & Suites",
  description: "Experience 5-star luxury at The Grand Haven. Premium accommodations, world-class amenities, and exceptional service in the heart of the city.",
  keywords: "luxury hotel, 5-star accommodation, business travel, premium suites, fine dining, spa wellness",
  openGraph: {
    title: "The Grand Haven - Luxury Hotel & Suites",
    description: "Experience 5-star luxury at The Grand Haven. Premium accommodations, world-class amenities, and exceptional service in the heart of the city.",
    siteName: "The Grand Haven",
    images: [{
      url: "https://images.pexels.com/photos/189295/pexels-photo-189295.jpeg?auto=compress&cs=tinysrgb&h=650&w=940",
      alt: "Elegant hotel lobby with marble floors and crystal chandeliers"
    }],
    type: "website"
  },
  twitter: {
    ...
    title: "The Grand Haven - Luxury Hotel & Suites",
    description: "Experience 5-star luxury at The Grand Haven. Premium accommodations, world-class amenities, and exceptional service.",
